...
// This is in origin from https://github.com/webrtc/samples/tree/gh-pages/src/content/devices/input-output MIT

function showSettings() {
  document.getElementById('settingsWrapper').classList.remove('hidden');
  let videoPreviewElement = document.querySelector('#videoPreviewElement');
  ...
  function changeAudioDestination() {
    ...
    attachSinkId(videoPreviewElement, audioDestination);
  }
